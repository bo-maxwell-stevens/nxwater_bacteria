...
# custom function to import GIBBs output files into phyloseq with EC data
# copied from above, edited by Heather
gibbs_to_phyloseq_EC <- function (RA_file=NULL, meta_file=NULL, sheet=NULL, 
                               range=NULL, sample_names=NULL, run_name=NULL) {
  otu <- read.csv(RA_file, header=T,  
                  row.names='X')
